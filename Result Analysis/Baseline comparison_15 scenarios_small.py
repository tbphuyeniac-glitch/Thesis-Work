"""
Baseline comparison_15 scenarios_small.py
==========================================
30-scenario baseline benchmark: 15 small scenarios
...
# 15 small scenarios: 4-6 stores, 2-4 products, 2-3 vehicles, 15-60 periods
SCENARIOS_SMALL = [
    {"label": "S01", "stores": 4, "products": 2, "vehicles": 2, "periods": 15},
    {"label": "S02", "stores": 4, "products": 2, "vehicles": 2, "periods": 30},
    {"label": "S03", "stores": 4, "products": 3, "vehicles": 2, "periods": 45},
    {"label": "S04", "stores": 4, "products": 3, "vehicles": 2, "periods": 20},
    {"label": "S05", "stores": 4, "products": 4, "vehicles": 2, "periods": 30},
    {"label": "S06", "stores": 5, "products": 2, "vehicles": 2, "periods": 45},
    {"label": "S07", "stores": 5, "products": 3, "vehicles": 2, "periods": 60},
    {"label": "S08", "stores": 5, "products": 4, "vehicles": 2, "periods": 15},
    {"label": "S09", "stores": 5, "products": 4, "vehicles": 3, "periods": 30},
    {"label": "S10", "stores": 6, "products": 2, "vehicles": 2, "periods": 60},
    {"label": "S11", "stores": 6, "products": 3, "vehicles": 2, "periods": 45},
    {"label": "S12", "stores": 6, "products": 3, "vehicles": 3, "periods": 60},
    {"label": "S13", "stores": 6, "products": 4, "vehicles": 2, "periods": 30},
    {"label": "S14", "stores": 6, "products": 4, "vehicles": 3, "periods": 45},
    {"label": "S15", "stores": 6, "products": 4, "vehicles": 3, "periods": 60},
]
...
def main():
    all_results = []
    total_scenarios = len(SCENARIOS_SMALL)

    for idx, cfg in enumerate(SCENARIOS_SMALL, 1):
        print(f"\n\n{'#'*80}")
    ...
    # ── Export to CSV ──────────────────────────────────────────────
    csv_path = "benchmark_results_15scenarios_small.csv"
    ...
    # ── Export to JSON ─────────────────────────────────────────────
    json_path = "benchmark_results_15scenarios_small.json"
    ...
    # ── Summary table ──────────────────────────────────────────────
    print(f"\n\n{'='*80}")
    print("FINAL SUMMARY: 15 Small Scenarios")
    print(f"{'='*80}\n")
    ...
    print("\n✓ Done. All 15 small scenarios completed.\n")
